        ...
        <Grid spacing={4} container justify="center">
          <Grid item xs={12} sm={8} md={4}>
            <Card className={classes.cardContainer}>
              <CardActionArea>
                <CardMedia component="img" alt="Weedmates" image={project5} />
                <CardContent
                  style={{ color: "#919191" }}
                ...
                >
                  ...
                  >
                    A friend and I were sitting around talking about weed and
              ...
              <CardActions className={classes.buttonContainer}>
                <Button
                  ...
                  href="https://github.com/jbaxter91/weedmates"
                  target="_blank"
                >
                  Github Repository
                </Button>
                <Button
                  size="small"
                  className={classes.button}
                  href="https://weedmates.herokuapp.com/"
                  target="_blank"
                >
                  Deployed Version
                </Button>
          ...
          <Grid item xs={12} sm={8} md={4}>
            <Card className={classes.cardContainer}>
              <CardActionArea>
                <CardMedia component="img" alt="Lil Fish Go" image={project2} />
                <CardContent>
                  <Typography
                    gutterBottom
                    variant="h5"
                  ...
                  <Typography
                    ...
                    className={classes.summary}
                  >
                    A fun flappy birds clone where you control a fish just
            ...
            <Card className={classes.cardContainer}>
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    className={classes.summary}
                  >
                    Super Similar is a passion project Sebastian Brear, Cynthia
              ...
              <CardActions className={classes.buttonContainer}>
                <Button
                  size="small"
                  className={classes.button}
                  href="https://github.com/ssbrear/group-project"
                  target="_blank"
                >
                  Github Repository
                </Button>
                <Button
                  size="small"
                  className={classes.button}
                  href="https://ssbrear.github.io/group-project/"
                  target="_blank"
                >
                  Deployed Version
                </Button>
            ...
            <Card className={classes.cardContainer}>
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    className={classes.summary}
                  >
                    This was a quick attempt at using an open api to get
              ...
              <CardActions className={classes.buttonContainer}>
                <Button
                  size="small"
                  className={classes.button}
                  href="https://github.com/jbaxter91/weather-forcast"
                  target="_blank"
                >
                  Github Repository
                </Button>
                <Button
                  size="small"
                  className={classes.button}
                  href="https://jbaxter91.github.io/weather-forcast/"
                  target="_blank"
                >
                  Deployed Version
                </Button>
              ...
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    className={classes.summary}
                  >
                    I wanted to test my skills in js by creating a timed quiz.
